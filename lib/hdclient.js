...
class HyperdriveClient {
    ...
    constructor(opts) {
        ...
        this.setupErrorAgent(opts.errorAgentOptions);
    }
    ...
    setupErrorAgent(options) {
         ...
         * https://scality.atlassian.net/browse/RING-28705
         *
         * Note that tests or any usage requires mocking an
         * errorAgent for hdclient to function. You can find
         * examples in:
