...
function keygen(serviceId, policy, objectContext, size,
    ...
    if ((dataLocations.length > 0 && dataLocations.some(e => e === null)) ||
        (codingLocations.length > 0 && codingLocations.some(e => e === null))) {
        /* We failed to sample appropriately, return an error */
        return null;
    }
