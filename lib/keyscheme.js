 ...
 * <endOffset> := used for splits. All split chunks share the same prefix,
 *                storing the offset is used to easily have range queries
 *                and avoid storing them all in the main key. End of chunk
 *                offset is used to be able to infer object real size from
 *                last chunk keys alone (only way to do it for erasure coded
 *                last chunk parts).
 */
 ...
 * @param {Number} endOffset - Offset inside object (cf split Design.md)
 ...
 * @param {Number} endOffset inside the whole object (see split Design.md)
