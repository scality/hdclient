 ...
 * <storedFragmentKey> := <serviceId>-<objectKey>-<rand>-<startOffset>-<fragid>
 * <serviceId>, <objectKey> and <rand> are the ones defined above.
 ...
 */
function fragmentKeygen(serviceId, prefix, rand, startOffset, fragmentId) {
    return [serviceId, prefix.slice(0, 20), rand, startOffset, fragmentId]
...
function makeFragment(context, uuid, startOffset, fragmentId) {
    return {
        fragmentId,
        uuid,
        key: fragmentKeygen(context.serviceId, context.objectKey,
                            context.rand, startOffset, fragmentId),
    };
}
 ...
 */
function keygen(serviceId, policy, objectKey, size,
