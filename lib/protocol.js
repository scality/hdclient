 ...
 * @returns {Map} keyed with the different types
 */
 ...
 * Transform the different payload information for PUT query
 * into a hyperdrive valid Content-Type string
 * @param {Array[]} payloads - typically [["data", [12]], ["meta"]]
 * @param {String} payloads[][0] - type (data, meta, usermd)
 * @param {Number|undefined} payloas[][1] - length of associated data
