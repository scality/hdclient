 ...
 */
function doPUT({ httpAgent, log, fragments, rawKey,
    ...
    const opContext = httpUtils.makeOperationContext(fragments, rawKey);
            ...
            const request = httpUtils.newRequest(
                ...
                reqCtx => {
                    ...
                    if (endStatus.timeout) {
                        return callback(null, opCtx.rawKey);
                    }

                    return callback(endStatus.error, opCtx.rawKey);
                });
